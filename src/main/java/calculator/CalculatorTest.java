...
//        System.out.println(Calculator.squareRootExtraction(169));
        ...
        // assertThatThrownBy(() -> seminars.first.Calculator.Calculator.squareRootExtraction(0, 1, -1)).isInstanceOf(SomeStateException.class);
       ...
       assertThatThrownBy(()-> Calculator.calculatingDiscount(-80.0, 20))
               .isInstanceOf(ArithmeticException.class);
       assertThatThrownBy(()-> Calculator.calculatingDiscount(80.0, 120))
               .isInstanceOf(ArithmeticException.class);
